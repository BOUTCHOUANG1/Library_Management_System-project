        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    Member newMember = new Member(memberId, name, firstName, email, membershipDate);
                ...
                case 9:
                    ...
                    if (foundMember != null) {
                        System.out.println("Member found: " + foundMember.getfirstName() + " " + foundMember.getlastName());
                    } else {
